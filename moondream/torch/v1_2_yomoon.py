...
# Global variables
vid = cv2.VideoCapture("/content/capture/liv.mp4")
goal_counter = 0
frame_counter = 0
rows, cols = 0, 0
class1_coords = None
...
def process_with_custom_moondream(img, coords):
    ...
    if len(prediction_window) == 20:
        ...
        if goal_count >= 14:
            ...
            print("gooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooool")
            return 0  # Return 0 to trigger video saving
    ...
    try:
        while True:
            ...
            if frame_counter % 6 == 0:  # Process every 6th frame
                ...
                if prediction == 0:  # If model predicts goal
                    save_pending = True
                    frames_after_prediction = 0
